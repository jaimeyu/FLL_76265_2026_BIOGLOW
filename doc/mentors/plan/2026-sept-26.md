...
>
> Today introduces practical __Crew Resource Management (CRM)__ (see our [Mentor CRM Guide](crew_resource_management.md)).
>
...
* **Handouts & Coach Materials:**
   * Print 10 copies of the [Pokémon CRM Kids Checklist Flyer](../../marketing/handouts/crew_resource_management_kids.html) ([Guide](../../marketing/handouts/crew_resource_management_kids.md)) for team binders and pit reference.
   * Print 2–3 cardstock copies of the [Mentor CRM Pocket Cue Card](mentor_crm_cue_card.html) ([Guide](mentor_crm_cue_card.md)) for coaches/mentors to keep in their pocket or wear on a lanyard.
...
* Introduce the golden 3-word rule: __Aviate, Navigate, Communicate__ (see [CRM Guide](crew_resource_management.md#%EF%B8%8F-the-core-pillar-aviate-navigate-communicate)):
...
45min is too much. We do not need to do ALL 4 challenges. We can rotate them for different sessions to keep them on their toes.
...
IGNORE! Looks like AI is hallucinating. This is not at all the topic for this season (last season) and not from my notes. Will update to match the homework. 
...
Since robot training was abbreviated in Session 2, we execute our full split-station rotation with the __Peer Ambassador Handoff__ (see [Coach's Notes](mentors_notes.md#2-the-peer-ambassador-system-intuitive-information-handoff)).
