...
> [!IMPORTANT]
> ### 🧭 The Golden Rule of DRI: "You Don't Do All the Work — You Organize, Collate & Safely Store It!"
>
> In FIRST LEGO League, **every single team member is expected to contribute** ideas, research facts, drawings, cardboard pieces, and presentation lines.
>
> The **DRI (Directly Responsible Individual)** does **not** do the job alone. Instead, the DRI is the **team's designated custodian & coordinator** for that domain:
> 1. **Collate & Gather:** Collect teammates' ideas, sketches, research notes, and parts so nothing gets scattered across tables.
> 2. **Track Progress:** Keep a quick running checklist of what the team has finished, who has open tasks, and what we need next.
> 3. **Safe Storage & Custody:** Make sure physical props, fragile prototypes, binders, receipts, and scripts are packed safely into their designated bins/folders so nothing gets lost or crushed between sessions!

| Role # | DRI Title | Pokémon Codename | Signature Move | Custodian Responsibilities (Collate, Track & Store) |
| :---: | :--- | :--- | :--- | :--- |
| **1** | **📦 Physical Presentation Lead** | **Machamp** 💪 | *Heavy Slam / Carry* | **Collate & Store Props:** Collects teammates' poster ideas and display materials. Tracks needed supplies (velcro, tape, markers). **Safe Storage:** Safely packs tri-fold boards and cardboard props into the team storage bin so they don't get bent or crushed! |
| **2** | **🔬 Research Lead** | **Alakazam** 🧠 | *Calm Mind / Archive* | **Collate & Store Research:** Gathers science facts, habitat articles, and web links found by teammates. Tracks source citations. **Safe Storage:** Maintains and protects the master Research Binder and project citation sheets so evidence is ready for judges. |
| **3** | **🛠️ Prototype Lead** | **Tinkaton** 🔨 | *Forge / Safeguard* | **Collate & Store Prototypes:** Coordinates mechanism ideas being built across tables. Tracks LEGO Technic linkages, mockups, and CAD files. **Safe Storage:** Safely houses the physical prototype model in its padded storage container so fragile parts don't break between meetings! |
| **4** | **🤝 Outreach Coordinator** | **Dragonite** 📬 | *Extreme Speed / Messenger* | **Collate & Store Feedback:** Collects interview questions from all teammates; tracks emails sent to marine biologists and domain experts. **Safe Storage:** Logs official expert responses (Version 1.0 $\rightarrow$ Feedback $\rightarrow$ Version 2.0) in the project binder. *(Crucial for the Rubric "Share" Rule!)* |
| **5** | **🎭 Creative Director** | **Jigglypuff** 🎤 | *Sing / Spotlight* | **Collate & Store Script:** Gathers dialogue ideas, jokes, and presentation themes from teammates. Tracks speaking times so all 8–9 kids have equal airtime. **Safe Storage:** Keeps the master 5-minute presentation script binder and laminated speaker cue cards safe. |
| **6** | **💰 Budget & Materials Accountant** | **Meowth** 🪙 | *Pay Day / Ledger* | **Collate & Store Receipts:** Collects supply wishlists from teammates before purchases. Tracks overall project expenses against our team budget. **Safe Storage:** Keeps the expense ledger, receipts envelope, and cost sheets organized in one secure folder. |
| **7** | **🕵️ Historical Intelligence & Video Scout** | **Greninja** 🥷 | *Shadow Sneak / Recon* | **Collate & Store Inspiration:** Gathers YouTube links and cool presentation ideas discovered by teammates from past FLL champions. **Safe Storage:** Maintains the team's "Inspiration Playbook" of video links and presentation notes for quick reference. |
| **8** | **🦆 Team Rubber Ducky** | **Psyduck** 🦆 | *Psychic Calm / Empathy* | **Collate & Store Team Wellness:** Actively checks in with teammates to see if anyone is stuck, overwhelmed, or frustrated. Listens blamelessly and tracks friction points. **Safe Storage:** Protects teammate trust—safely bridges feedback to mentors without pointing fingers. |
| **9** | **⚡ Energy & Time Captain** *(Co-Lead / 9th Member)* | **Pikachu** ⚡ | *Volt Tackle / Spark* | **Collate & Store Match Timing:** Tracks the countdown clock during 5-minute timed rehearsals and monitors activity transitions. **Safe Storage:** Keeps the team stopwatch, timer tablet, and cheer banner packed safely for each session. |
...
sequenceDiagram
    autonumber
    participant A as Group A (Chassis Builders)
    participant AmbA as Station A Ambassadors
    participant AmbB as Station B Ambassadors
    participant B as Group B (Motor Programmers)

    Note over A,B: Block 1 (30 min) - Master respective stations
    Note over AmbA,AmbB: 2:25 PM - Pick 1-2 Peer Ambassadors per station

    rect rgb(240, 248, 255)
        Note over A,B: Phase 1: Station Swap and Peer Teaching (10 min)
        A->>B: Group A moves to Station B
        B->>A: Group B moves to Station A
        AmbB-->>A: AmbB teaches incoming Group A motor calibration
        AmbA-->>B: AmbA teaches incoming Group B modular lock system
    end

    rect rgb(245, 255, 245)
        Note over A,B: Phase 2: Ambassadors Return and Reverse Handoff (15 min)
        AmbB->>A: AmbB rejoins Group B at Station A
        AmbA->>B: AmbA rejoins Group A at Station B
        B-->>AmbB: Group B catches up AmbB on chassis assembly
        A-->>AmbA: Group A catches up AmbA on motor code tested
    end
```
